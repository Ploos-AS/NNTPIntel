...
def topology_incidents_page(storage: Storage) -> str:
    ...
    rows = "".join(
        ...
        "</tr>"
        for item in incidents
    ) or '<tr><td colspan="13">No topology incidents recorded.</td></tr>'
...
<p><a href="/web/propagation/topology">← Inferred topology</a> · <a href="/web/propagation/topology/anomalies">Anomalies</a> · <a href="/web/propagation/topology/impact">Impact / centrality</a> · <a href="/web/propagation/topology/quality">Data quality</a></p>
...
<table><thead><tr><th>ID</th><th>Server</th><th>Type</th><th>Severity</th><th>Status</th><th>Triage</th><th>Evidence</th><th>Coverage</th><th>Freshness</th><th>Impact</th><th>Started</th><th>Updated</th><th>Resolved</th></tr></thead><tbody>{rows}</tbody></table>
</main></body></html>"""
