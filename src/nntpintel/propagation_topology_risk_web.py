...
def risk_page(storage: Storage) -> str:
    ...
    ) or '<tr><td colspan="11">No topology risk data yet.</td></tr>'
    community_rows = "".join(
        "<tr>"
    ...
    ) or '<tr><td colspan="8">No topology communities yet.</td></tr>'
...
<p><a href="/web/propagation/topology">← Inferred topology</a> · <a href="/web/propagation/topology/quality">Data quality</a> · <a href="/web/propagation/topology/resilience">Resilience</a> · <a href="/web/propagation/topology/incidents">Incidents</a></p>
...
<h3>Server priority</h3><table><thead><tr><th>Server</th><th>Cluster</th><th>Risk</th><th>Level</th><th>Evidence</th><th>Coverage</th><th>Freshness</th><th>Incidents</th><th>Impact</th><th>Resilience</th><th>Gateway</th></tr></thead><tbody>{server_rows}</tbody></table>
<h3>Community priority</h3><table><thead><tr><th>Cluster</th><th>Risk</th><th>Level</th><th>Evidence</th><th>Servers</th><th>Incidents</th><th>Affected servers</th><th>Gateways</th></tr></thead><tbody>{community_rows}</tbody></table>
