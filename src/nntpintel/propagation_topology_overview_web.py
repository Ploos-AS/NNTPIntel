...
def overview_page(storage: Storage) -> str:
    ...
    ) or '<tr><td colspan="4" class="muted">No current topology items require elevated attention.</td></tr>'
    server_rows = "".join(
        "<tr>"
    ...
    ) or '<tr><td colspan="5" class="muted">No inferred topology servers yet.</td></tr>'
...
<p><a href="/web/propagation/topology">← Topology</a> · <a href="/web/propagation/topology/risk">Risk synthesis</a> · <a href="/web/propagation/topology/incidents">Incidents</a> · <a href="/web/propagation/topology/anomalies">Anomalies</a></p>
...
<h2>What needs attention now</h2><table><thead><tr><th>Priority</th><th>Signal</th><th>Target</th><th>Why</th></tr></thead><tbody>{attention_rows}</tbody></table>
<h2>Highest-priority servers</h2><table><thead><tr><th>Server</th><th>Risk</th><th>Level</th><th>Incidents</th><th>Gateway</th></tr></thead><tbody>{server_rows}</tbody></table>
