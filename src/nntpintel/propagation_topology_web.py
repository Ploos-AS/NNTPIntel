...
<p><a href="/web/propagation">← Propagation</a> · <a href="/web/propagation/topology/history">Topology history / stability</a> · <a href="/web/propagation/topology/anomalies">Topology anomalies</a></p><h2>Inferred propagation topology</h2>
