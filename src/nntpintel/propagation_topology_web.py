...
<p><a href="/web/propagation">← Propagation</a> · <a href="/web/propagation/topology/overview">Executive overview</a> · <a href="/web/propagation/topology/history">Topology history / stability</a> · <a href="/web/propagation/topology/anomalies">Topology anomalies</a> · <a href="/web/propagation/topology/incidents">Topology incidents</a> · <a href="/web/propagation/topology/impact">Impact / centrality</a> · <a href="/web/propagation/topology/communities">Communities / clusters</a> · <a href="/web/propagation/topology/cross-cluster">Cross-cluster</a> · <a href="/web/propagation/topology/resilience">Resilience / critical paths</a> · <a href="/web/propagation/topology/risk">Risk synthesis</a></p><h2>Inferred propagation topology</h2>
