...
def communities_page(storage: Storage) -> str:
    ...
    ) or '<tr><td colspan="9">No inferred topology communities yet.</td></tr>'
...
<p><a href="/web/propagation/topology">← Inferred topology</a> · <a href="/web/propagation/topology/impact">Impact / centrality</a> · <a href="/web/propagation/topology/incidents">Topology incidents</a></p>
...
<table><thead><tr><th>Cluster</th><th>Servers</th><th>Edges</th><th>Members</th><th>Avg confidence</th><th>Avg impact</th><th>Max impact</th><th>Open incidents</th><th>Affected servers</th></tr></thead><tbody>{rows}</tbody></table>
</main></body></html>"""
